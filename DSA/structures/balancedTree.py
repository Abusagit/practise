...
from DSA.structures.binaryTree import height
...
class AVLTree(BinarySearchTree):
    ...
    def adjust_del_balance(self, pos: TreeNode, rightHeight=None, leftHeight=None):
        ...
        if pos.isLeftChild():
            ...
            self.adjust_del_balance(pos.parent, rightHeight=subtreeHeight)

    def __delitem__(self, key):
        position = super(AVLTree, self).__delitem__(key)
        self.adjust_del_balance(position)
        self.updateBalance(position)
